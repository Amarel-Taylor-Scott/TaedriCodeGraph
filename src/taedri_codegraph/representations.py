...
def core_representation_registry() -> RepresentationRegistry:
    ...
    registry.register_many(
        (
            ...
            descriptor("uceg.family.artifact", "uceg.artifact.source_uri", (ValueKind.TEXT,), ("exact", "lexical"), ("snapshot",)),
            descriptor("uceg.family.artifact", "uceg.artifact.acquisition_receipt", (ValueKind.JSON,), (), ("snapshot",)),
            descriptor("uceg.family.artifact", "uceg.artifact.pypi.metadata_digest", (ValueKind.DIGEST,), ("exact",), ("snapshot",)),
            descriptor("uceg.family.artifact", "uceg.artifact.git.repository", (ValueKind.KEYWORD,), ("exact", "facet"), ("snapshot",)),
            descriptor("uceg.family.artifact", "uceg.artifact.git.commit", (ValueKind.KEYWORD,), ("exact",), ("snapshot",)),
            descriptor("uceg.family.artifact", "uceg.artifact.git.tree", (ValueKind.KEYWORD,), ("exact",), ("snapshot",)),
